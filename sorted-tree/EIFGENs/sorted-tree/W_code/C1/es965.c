...
#define ui4_2 ui4_2x.it_i4
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(5726, Dtype(tr1)))(tr1);
	RTNHOOK(3,1);
	loc1 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(4);
	RTDBGAL(Current, 2, 0xF80003EA, 0, 0); /* loc2 */
	tr1 = RTLN(eif_new_type(1002, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(5764, Dtype(tr1)))(tr1);
	RTNHOOK(4,1);
...
body:;
	...
	RTHOOK(9);
	loc1 = RTCCL(arg1);
	loc1 = RTRV(eif_new_type(987, 0x01),loc1);
	if (EIF_TEST(loc1)) {
		RTHOOK(10);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5043, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(10,1);
...
body:;
	...
	RTHOOK(17);
	loc5 = RTCCL(arg1);
	loc5 = RTRV(eif_new_type(987, 0x01),loc5);
	if (EIF_TEST(loc5)) {
		RTHOOK(18);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5043, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(18,1);
