...
extern void F988_7541(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5294, 0xF8000105, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
	...
	*(EIF_REFERENCE *)(Current + RTWA(5292, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5296, 0xF80000E8, 0); /* expected_tag_name */
...
void F988_7541 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 987, Current, 0, 3, 13788);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTCC(arg3, 987, l_feature_name, 3, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 987, Current, 3, 0, 13789);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((EIF_BOOLEAN) !loc1) {
		...
		*(EIF_BOOLEAN *)(Current + RTWA(5288, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTE_E
