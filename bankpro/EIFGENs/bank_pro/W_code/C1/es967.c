...
extern void F967_7275(EIF_REFERENCE);
extern void F967_7276(EIF_REFERENCE);
extern void F967_7277(EIF_REFERENCE);
extern void F967_7278(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F967_7279(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F967_7284(EIF_REFERENCE);
...
void F967_7275 (EIF_REFERENCE Current)
{
	GTCX
...
void F967_7276 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 966, Current, 0, 0, 13556);
	RTSA(Dtype(Current));
	RTSC;
...
void F967_7277 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 966, Current, 0, 0, 13557);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
void F967_7278 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
void F967_7279 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
EIF_TYPED_VALUE F967_7281 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 966, Current, 0, 0, 13560);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(966, Current, 13560);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 966, Current, 0, 1, 13561);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(966, Current, 13561);
	RTCC(arg1, 966, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 966, Current, 0, 1, 13562);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
void F967_7284 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 966, Current, 6, 0, 13549);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
