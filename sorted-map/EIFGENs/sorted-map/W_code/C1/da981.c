...
extern EIF_TYPED_VALUE F981_7471(EIF_REFERENCE);
extern EIF_TYPED_VALUE F981_7472(EIF_REFERENCE);
extern EIF_TYPED_VALUE F981_7473(EIF_REFERENCE);
...
EIF_TYPED_VALUE F981_7471 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(5232,Dtype(Current)));
	return r;
}


/* {DATE_TIME_VALUE}.time */
EIF_TYPED_VALUE F981_7472 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F981_7473 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5197, "fractional_second", tr1));
