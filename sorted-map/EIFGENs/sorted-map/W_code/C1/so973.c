...
void F973_7377 (EIF_REFERENCE Current)
{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5151, 0xF80003EA, 0); /* map */
	...
	*(EIF_REFERENCE *)(Current + RTWA(5151, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5150, 0xF80003FB, 0); /* s_map */
...
static EIF_TYPED_VALUE F973_7378_body (EIF_REFERENCE Current)
{
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1002,221,0xFF01,232,0xFFFF};
		EIF_TYPE typres0;
...
static EIF_TYPED_VALUE F973_7381_body (EIF_REFERENCE Current)
{
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1019,0xFF01,232,221,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
